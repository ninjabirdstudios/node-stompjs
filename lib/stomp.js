...
Frame.prototype.determineContentType = function (defaultMimeType, defaultEncoding)
{
    ...
    if (index >= 0)
    {
        ...
        if (te.length > 1)
        {
            ...
            {
                var     encoding = encodingParts[1].trim().toLowerCase();
...
Frame.prototype.setBodyFromObject = function (obj)
{
    ...
    this.appendContentType('text/json', 'utf16le');
    this.appendContentLength(buffer);
    this.bodyData = buffer;
    return this;
};

/// Reconstructs an Object instance encoded as JSON text in the message body.
/// @return An Object representing the decoded message body.
Frame.prototype.getObjectFromBody = function ()
{
    var bodyInfo = this.determineContentType('text/json', 'utf16le');
    var bodyJSON = this.bodyData.toString(bodyInfo.encoding);
...
ClientConnector.prototype.connectHandler = function (connection)
{
    ...
    var frame  = this.createConnect(broker, user, pass, '1.0,1.1');
